// File: maxxalan/playing-filmp2p/Playing-FilmP2P-main/pages/HomePage.tsx
...
  // FIX 1: Thêm state để kiểm soát việc tạm dừng/tiếp tục chuyển động của Hero
...
      // FIX 2: Chỉ chạy setInterval khi không bị tạm dừng
...
      };
    }
  }, [movies, isHeroPaused]); // Thêm isHeroPaused vào dependency array
...
  return (
    <>
      {/* FIX 3: Truyền prop để Hero có thể điều khiển animation chuyển cảnh */}
      <Hero 
        movie={featuredMovie} 
        key={featuredMovie?.id} 
        onHoverChange={setIsHeroPaused} 
      />
